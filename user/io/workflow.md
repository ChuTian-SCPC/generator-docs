...
Generator Name : gen
+------------+----------+-------+-------------------------------------------+
|Hack Case Id|tle2      |wa     |Move Path                                  |
+------------+----------+-------+-------------------------------------------+
|1           |N/A       |WA 23ms|E:\code\ACM-generator\debug\testcases\5.in |
+------------+----------+-------+-------------------------------------------+
|8           |TLE 1106ms|Skip   |E:\code\ACM-generator\debug\testcases\6.in |
+------------+----------+-------+-------------------------------------------+
|9           |TLE 1106ms|Skip   |E:\code\ACM-generator\debug\testcases\7.in |
+------------+----------+-------+-------------------------------------------+
|10          |TLE 1117ms|Skip   |E:\code\ACM-generator\debug\testcases\8.in |
+------------+----------+-------+-------------------------------------------+
|11          |TLE 1119ms|N/A    |E:\code\ACM-generator\debug\testcases\9.in |
+------------+----------+-------+-------------------------------------------+
|12          |TLE 1101ms|N/A    |E:\code\ACM-generator\debug\testcases\10.in|
+------------+----------+-------+-------------------------------------------+
Generator Name : large_gen
+------------+----------+-------------------------------------------+
|Hack Case Id|tle       |Move Path                                  |
+------------+----------+-------------------------------------------+
|1           |TLE 1113ms|E:\code\ACM-generator\debug\testcases\11.in|
+------------+----------+-------------------------------------------+
|2           |TLE 1104ms|E:\code\ACM-generator\debug\testcases\12.in|
+------------+----------+-------------------------------------------+
...
+-----------+-----+----------+--------------+--------------+-------+-------+
|1          |N/A  |N/A       |TLE(AC) 1563ms|N/A           |AC 27ms|WA 52ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
|2          |N/A  |N/A       |TLE(AC) 1544ms|N/A           |WA 24ms|AC 28ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
|3          |N/A  |N/A       |TLE(AC) 1530ms|N/A           |WA 23ms|AC 21ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
|4          |RE   |TLE 2110ms|TLE(AC) 1548ms|N/A           |WA 22ms|AC 25ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
|5          |RE   |TLE 2109ms|TLE(AC) 1544ms|N/A           |WA 27ms|AC 22ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
|6          |RE   |TLE 2118ms|N/A           |TLE(WA) 1551ms|WA 22ms|AC 25ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
|7          |RE   |TLE 2114ms|N/A           |TLE(WA) 1542ms|WA 21ms|AC 31ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
|8          |N/A  |N/A       |N/A           |TLE(WA) 1541ms|WA 21ms|AC 25ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
|9          |N/A  |N/A       |N/A           |TLE(AC) 1532ms|AC 22ms|WA 22ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
|10         |N/A  |N/A       |N/A           |TLE(WA) 1552ms|WA 23ms|AC 23ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
|11         |N/A  |N/A       |N/A           |N/A           |WA 22ms|AC 27ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
|12         |N/A  |N/A       |N/A           |N/A           |WA 23ms|AC 22ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
|Total      |RE   |TLE 2118ms|TLE(AC) 1563ms|TLE(WA) 1552ms|WA 27ms|WA 52ms|
+-----------+-----+----------+--------------+--------------+-------+-------+
```
